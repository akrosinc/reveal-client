...
public class JsonFormActivity extends JsonFormBaseActivity implements JsonApi {
    ...
    public void writeValue(String stepName, String parentKey, String childObjectKey, String childKey, String value,
        ...
        Timber.tag("WriteValue").i("JsonFormActivity writeValue stepName %s parentKey %s childObjectKey %s childKey %s value %s",
        ...
        if (invokeRefreshLogic(stepName, parentKey, childKey, value)) {
            ...
            Timber.tag("WriteValue").i("JsonFormActivity about to checkBoxWriteValue ");
        ...
        appExecutors.diskIO().execute(() ->{
            ...
            for (String viewId : viewsIds) {
                try {
                    ...
                    Timber.tag("WriteValue").e(e, "%s refreshCalculationLogic()", this.getClass().getCanonicalName());
    ...
    @Override
    public Map<String, View> getFormDataViewMap() {
    ...
    protected void checkBoxWriteValue(String stepName, String parentKey, String childObjectKey, String childKey,
        ...
        synchronized (getmJSONObject()) {
            ...
            Timber.tag("WriteValue").i("JsonFormActivity checkBoxWriteValue 1 checkboxObject %s",
                checkboxObject);
            //Get current values
    ...
    private void setReadOnlyAndFocus(View view, boolean visible, boolean popup) {
        try {
            ...
            Timber.tag("WriteValue").e(e, "JsonFormActivity --> setReadOnlyAndFocus");
        }
    }
    ...
    private void setReadOnlyRadioButtonOptions(View view, boolean enabled) {
        if (view != null) {
            try {
                ...
                Timber.tag("WriteValue").e(e, " --> setReadOnlyRadioButtonOptions");
            }
        }
    }

    private void checkViewConstraints(View curView, boolean popup) {
//        Timber.tag("WriteValue").i("here");
...
//        Timber.tag("WriteValue").i("here 2");
        if (constraintTag != null && constraintTag.length() > 0) {
            try {

                String errorMessage = null;
                String[] address = null;
//                Timber.tag("WriteValue").i("here 3");
                if (constraintTag.charAt(0) == '[') {
                    String addressString = (String) curView.getTag(R.id.address);
//                    Timber.tag("WriteValue").i("here 3.1 addressString %s",addressString);
                    address = addressString.split(":");

                    JSONArray constraint = new JSONArray(constraintTag);
//                    Timber.tag("WriteValue").i("here 4");
                    for (int i = 0; i < constraint.length(); i++) {
                        JSONObject curConstraint = constraint.getJSONObject(i);
//                        Timber.tag("WriteValue").i("here 5");
                        if (address.length == 2) {
//                            Timber.tag("WriteValue").i("here 5.1 %s",address);
                            Facts valueFromAddress = getValueFromAddress(address, popup);
//                            Timber.tag("WriteValue").i("here 5.2 %s",address);
                            char[] data = new char[0];
                            Object data1 = valueFromAddress.get(JsonFormConstants.VALUE);
                            try{
                                data = (char[]) data1;
                            } catch (Exception e){
                                data = String.valueOf(data1).toCharArray();
                            }
//                            Timber.tag("WriteValue").i("here 5.3 %s",address);
                            String value = String.valueOf(data);
//                            Timber.tag("WriteValue").i("here 5.4 %s",value);
                            errorMessage = enforceConstraint(value, curView, curConstraint);
//                            Timber.tag("WriteValue").i("here 5.5 %s",address);
                            if (errorMessage != null) break;
//                            Timber.tag("WriteValue").i("here 5.6 %s",address);
                        }
//                        Timber.tag("WriteValue").i("here 5.7");
                    }
...
//                Timber.tag("WriteValue").i("here 6");
                updateUiByConstraints(curView, popup, errorMessage);
//                Timber.tag("WriteValue").i("here 7");
            } catch (Exception e) {
                Timber.tag("WriteValue").e( "JsonFormActivity --> checkViewConstraints");
...
//        Timber.tag("WriteValue").i("here 5.1.1 getValueFromAddress %s",address);
        JSONObject object = getObjectUsingAddress(address, popup);
//        Timber.tag("WriteValue").i("here 5.1.2 getValueFromAddress %s",address);

        Facts entries = getEntries(address, object);
//        Timber.tag("WriteValue").i("here 5.1.3 getValueFromAddress %s",address);
...
//                Timber.tag("WriteValue").i("JsonFormActivity --> getFunctionArgs curArg %s",curArg);
                ...
                if (".".equals(curArg)) {
                    ...
                    if (valueMatcher.find()) {
                        ...
                        try {
//                            Timber.tag("WriteValue").i("JsonFormActivity --> getFunctionArgs 1 curArg %s",curArg);
                            String[] split = curArg.split(":");
//                            Timber.tag("WriteValue").i("JsonFormActivity --> getFunctionArgs 2 curArg %s",curArg);
                            Facts valueFromAddress = getValueFromAddress(split, false);
//                            Timber.tag("WriteValue").i("JsonFormActivity --> getFunctionArgs 3 curArg %s",valueFromAddress);
                            Object data1 = valueFromAddress.get(JsonFormConstants.VALUE);
                            char[] data = new char[0];
                            try{
                                data = (char[]) data1;
...
//                            Timber.tag("WriteValue").i("JsonFormActivity --> getFunctionArgs 4 curArg %s",curArg);

                            args[i] = String.valueOf(
                                data);
//                            Timber.tag("WriteValue").i("JsonFormActivity --> getFunctionArgs 5 curArg %s",curArg);
                        } catch (Exception e) {
                            Timber.tag("WriteValue").e("JsonFormActivity --> getFunctionArgs");
    ...
    protected void refreshMediaLogic(String key, String value, String stepName) {
        ...
        try {
            ...
            Timber.tag("WriteValue").e(e, "JsonFormActivity --> refreshMediaLogic");
        }
    }
    ...
    public void mediaDialog(JSONObject media, String value) {
        try {
            ...
            Timber.tag("WriteValue").e(e, "JsonFormActivity --> mediaDialog");
        }
    }
...
//            Timber.tag("WriteValue").i("here 5.5 %s %s %s %s",type,functionName,args,viewDoesNotHaveValue);
//            for (String arg : args) {
//                Timber.tag("WriteValue").i("here 5.5 arg %s ",arg);
//            }
            if (checkViewValues(type, functionName, args, viewDoesNotHaveValue)) return null;
//            Timber.tag("WriteValue").i("here 5.6 %s",value);
        } else {
            Timber.tag("WriteValue").d("Matcher didn't work with function");
        }
//        Timber.tag("WriteValue").i("here 5.7 %s",errorMessage);
        return errorMessage;
    }
    ...
    protected JSONArray fetchFields(JSONObject parentJson, boolean popup) {
        ...
        try {
            ...
            Timber.tag("WriteValue").e(e, "JsonFormActivity --> fetchFields");
        }
        ...
        if (genericDialogInterface != null && genericDialogInterface.getWidgetType() != null &&
            ...
            if (parentJson.has(JsonFormConstants.HAS_EXTRA_REL)) {
                ...
                try {
                    ...
                    Timber.tag("WriteValue").e(e, "JsonFormActivity --> specifyFields");
                }
            }
        }
        return fields;
    ...
    private JSONArray returnFields(JSONObject jsonObject) {
        ...
        try {
            ...
            Timber.tag("WriteValue").e(e, "JsonFormActivity --> returnFields");
        }
        return fields;
    }
    ...
    protected JSONArray getSubFormFields(String subFormName, String subFormLocation, JSONArray
        ...
        if (jsonObject != null) {
            try {
                ...
                Timber.tag("WriteValue").e(e, "JsonFormActivity --> getSubFormFields");
            }
        }
        ...
        if (curRelevance != null) {
            if (curRelevance.has(JsonFormConstants.JSON_FORM_KEY.EX_RULES)) {
                ...
                if (exRulesObject.has(RuleConstant.RULES_FILE)) {
                    ...
                    boolean b =
                        curValueMap.asMap().size() != 0 && getRulesEngineFactory().getRelevance(
                            curValueMap,
    ...
    private List<String> getRules(String filename, String fieldKey, boolean readAllRules) {
        ...
        if (rules == null) {
            try {
                ...
                Timber.tag("WriteValue").e(e, "JsonFormActivity --> getRules");
            }
    ...
    private void updateCalculation(Facts valueMap, View view, String[] address,
        ...
        try {
            ...
            Timber.tag("WriteValue").e(e, "calling updateCalculation on Non TextView or Text View decendant");
        }
    ...
    public void refreshExpansionPanel(RefreshExpansionPanelEvent refreshExpansionPanelEvent) {
        if (refreshExpansionPanelEvent != null) {
            try {
                ...
                Timber.tag("WriteValue").e(e, "JsonFormActivity --> refreshExpansionPanel");
            }
        }
