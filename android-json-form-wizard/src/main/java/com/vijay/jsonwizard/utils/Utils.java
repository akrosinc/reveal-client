        ...
        if (rules != null) {
            if (rules.has(RuleConstant.RULES_ENGINE) && context != null) {
                ...
                for (Map<String, Object> map : mapArrayList) {
                    ...
                    jsonRulesDynamicObject.put(RuleConstant.NAME, String.valueOf(map.get(RuleConstant.NAME)).concat("|").concat(uniqueId));
                    jsonRulesDynamicObject.put(RuleConstant.DESCRIPTION, String.valueOf(map.get(RuleConstant.DESCRIPTION)).concat("|").concat(uniqueId));
