...
//                Timber.tag("WriteValue").i("sections remoteReferenceEditTextStep %s remoteReferenceEditTextKey %s",addressSections[0],addressSections[1]);
                ...
                if (stepJsonObject != null) {
                    ...
                    for (int i = 0; i < fields.length(); i++) {
                        ...
                        if (stepField != null && stepField.has(KEY) && stepField.getString(KEY).equals(remoteReferenceEditTextKey)) {
                            ...
                            Timber.tag("WriteValue").i("found reference remoteReferenceEditTextKey %s",remoteReferenceEditTextKey);
                            ...
                            if (!StringUtils.isEmpty(fieldValue)) {
                                try {
                                    ...
                                    Timber.tag("WriteValue").i(" remoteReferenceEditTextKey visibilityTag %s",visibilityTag);
                                    ...
                                    Timber.tag("WriteValue").e(ex,"Error remoteReferenceEditTextKey");
                                }
                            }
                        }
                    }
