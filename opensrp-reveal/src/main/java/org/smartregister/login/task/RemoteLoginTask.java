...
public class RemoteLoginTask extends AsyncTask<Void, Integer, LoginResponse> {
    ...
    protected LoginResponse doInBackground(Void... params) {
        ...
        try {
            ...
            if (accountConfiguration != null) {
                ...
                loginResponse = getOpenSRPContext().userService().fetchUserDetails(response.getAccessToken());// :Not fetching user detailsf for now
                loginResponse = saveUserDetails(loginResponse,mAccountManager,response );  //saving differently
    ...
    private LoginResponse saveUserDetails(LoginResponse loginResponse,AccountManager mAccountManager,AccountResponse response ){
        ...
        if (loginResponse != null && loginResponse.equals(LoginResponse.SUCCESS)) {
            ...
            //TODO: Handle pulling down of Settings...
