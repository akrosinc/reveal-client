...
public class HdssRepository extends BaseRepository {
    ...
    public void moveIndividualFromHouseholdToHousehold(String fromHoushold, String toHoushold, String individual){
        ...
        addOrUpdateHouseholdIndividual(List.of(new HdssHouseholdIndividual(toHoushold,individual)));
    }
    ...
    public List<HdssIndividual> getIndividualsByHouseholdId(String householdId){
        ...
        String query = "SELECT " +" i."+IDENTIFIER+"," +
                "i."+INDIVIDUAL_ID+", i."+DOB+", i."+GENDER+" From "+HDSS_HOUSEHOLD_INDIVIDUAL+" hc \n" +
        ...
        if (cursor != null ) {
            if ( cursor.moveToFirst()) {
                do {
                    ...
                    HdssIndividual hdssIndividual = new HdssIndividual(identifier,individualId,dob,gender);
    ...
    public List<HdssIndividual> getIndividuals(){
        ...
        String query = "SELECT " +" i."+IDENTIFIER+"," +
                "i."+INDIVIDUAL_ID+", i."+DOB+", i."+GENDER
    ...
    public List<HdssCompoundHousehold> getHouseholdCompound(){
        ...
        String query = "SELECT compound_id, household_id  from hdss_compound_household" ;
        ...
        if (cursor != null ) {
            if ( cursor.moveToFirst()) {
                do {
                    ...
                    HdssCompoundHousehold compoundHousehold = new HdssCompoundHousehold(compoundId,householdId);
    ...
    public List<HdssCompoundHousehold> getCompoundAndHouseholdByStructureId(String structureId){
        String query = "    SELECT hc.compound_id,hch.household_id, hhs.structure_id from hdss_compound hc " +
        ...
        if (cursor != null ) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    HdssCompoundHousehold hdssCompoundHousehold = new HdssCompoundHousehold(compound,householdId);
