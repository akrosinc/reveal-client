...
//        EmojiCompat.init(
//            new BundledEmojiCompatConfig(this)
//        );
        Log.d("SYNC_TRACE", "APP_ONCREATE_START t=" + System.currentTimeMillis());
        mInstance = this;
        ...
        Log.d("SYNC_TRACE_RVL","APP_ONCREATE — isSyncInProgress flag reset to false");
        Log.d("SYNC_TRACE", "CORE_LIBRARY_INIT_DONE t=" + System.currentTimeMillis());
