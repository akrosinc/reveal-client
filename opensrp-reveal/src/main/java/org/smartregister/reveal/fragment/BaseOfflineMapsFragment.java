...
public abstract class BaseOfflineMapsFragment extends Fragment implements OfflineMapsFragmentContract.View {
    ...
    /**
     * Triggered when native Mapbox starts or updates download progress.
     */
    public void triggerDownloadProgress(String mapUniqueName, double percentage) {
        currentMapDownload = mapUniqueName;
        displayToast(getString(R.string.map_download_progress, percentage));
        downloadStarted(mapUniqueName);
    }

    /**
     * Triggered when native Mapbox completes the offline download successfully.
     */
    public void triggerDownloadComplete(String mapUniqueName) {
    ...
    /**
     * Triggered when native Mapbox encounters an error during download.
     */
    public void triggerDownloadError(String mapUniqueName, String errorMsg) {
        currentMapDownload = null;
        displayError(R.id.download_map, errorMsg);
