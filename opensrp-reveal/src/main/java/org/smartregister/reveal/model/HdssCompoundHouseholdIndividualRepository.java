...
public class HdssCompoundHouseholdIndividualRepository implements MultiSelectListRepository {
    @Override
    public List<MultiSelectItem> fetchData() {
        ...
        List<HdssIndividualHouseHoldCompound> individualHouseholdCompounds = hdssRepository.getIndividualHouseholdCompound();
        ...
        if (individualHouseholdCompounds != null){
            multiSelectItems = individualHouseholdCompounds.stream().map(individualHouseholdCompound->{
                ...
                item.setKey(individualHouseholdCompound.getIndividualId());
                item.setText(individualHouseholdCompound.getIndividualId());
                item.setText2(individualHouseholdCompound.getHouseholdId());
                item.setText3(individualHouseholdCompound.getCompoundId());
                item.setLabel1("Individual Id");
                item.setLabel2("Household Id");
                item.setLabel3("Compound Id");
