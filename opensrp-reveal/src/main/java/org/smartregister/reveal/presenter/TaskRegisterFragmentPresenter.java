...
public class TaskRegisterFragmentPresenter extends BaseFormFragmentPresenter implements TaskRegisterFragmentContract.Presenter {
    ...
    // Mapbox LocationEngineCallback Implementations
    @Override
    ...
    public void onFailure(@NonNull Exception exception) {
        Timber.e(exception, "Error obtaining location update via Mapbox LocationEngine");
    }
    ...
    public void onDestroy() {
        if (getView() != null && getView().getLocationUtils() != null) {
            getView().getLocationUtils().stopLocationClient(this);
        }
    }
