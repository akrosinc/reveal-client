...
//import org.smartregister.reveal.permission.RevealMultiplePermissionListener;
//
...
//import io.ona.kujaku.views.Dialogs;
...
// */
//public class KujakuMapViewOverride extends MapView implements IKujakuMapView, MapboxMap.OnMapClickListener, MapboxMap.OnMapLongClickListener {
//
//    private static final String TAG = KujakuMapViewOverride.class.getName();
...
//    public KujakuMapViewOverride(@NonNull Context context) {
//        super(context);
//        init(null);
//    }
//
//    public KujakuMapViewOverride(@NonNull Context context, @Nullable AttributeSet attrs) {
//        this(context);
////        super(context, attrs);
//        init(attrs);
//    }
//
//
//    public KujakuMapViewOverride(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
//        super(context, attrs, defStyleAttr);
//        init(attrs);
//    }
//
//    public KujakuMapViewOverride(@NonNull Context context, @Nullable MapboxMapOptions options) {
...
//
//            MultiplePermissionsListener dialogMultiplePermissionListener = new RevealMultiplePermissionListener(activity);
//
//
...
//        checkPermissions(TAG, getContext());
//
...
//                    KujakuMapViewOverride.this.mapboxMap = mapboxMap;
...
//        if (KujakuMapViewOverride.this.droppedPoints != null) {
//            List<io.ona.kujaku.domain.Point> droppedPoints = new ArrayList<>(KujakuMapViewOverride.this.droppedPoints);
...
//
//        mapboxLocationComponentWrapper.init(KujakuMapViewOverride.this.mapboxMap, getContext(), locationRenderMode);
//    }
//
...
//                @Override
//                public void onStyleLoaded(@NonNull Style style) {
//                    ((GeoJsonSource) style.getSource(primaryGeoJsonSource.getId())).setGeoJson(KujakuMapViewOverride.this.featureCollection);
//                }
//            });
//        }
//    }
