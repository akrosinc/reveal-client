...
import com.revealprecision.reveal.contract.BaseDrawerContract;
import com.revealprecision.reveal.contract.ListTaskContract;
import com.revealprecision.reveal.contract.PasswordRequestCallback;
import com.revealprecision.reveal.contract.UserLocationContract.UserLocationCallback;
import com.revealprecision.reveal.interactor.ListTaskInteractor;
import com.revealprecision.reveal.model.CardDetails;
import com.revealprecision.reveal.model.FamilyCardDetails;
import com.revealprecision.reveal.model.IRSVerificationCardDetails;
import com.revealprecision.reveal.model.MosquitoHarvestCardDetails;
import com.revealprecision.reveal.model.SprayCardDetails;
import com.revealprecision.reveal.model.TaskDetails;
import com.revealprecision.reveal.model.TaskFilterParams;
import com.revealprecision.reveal.repository.RevealMappingHelper;
import com.revealprecision.reveal.task.IndicatorsCalculatorTask;
import com.revealprecision.reveal.util.AlertDialogUtils;
import com.revealprecision.reveal.util.CardDetailsUtil;
import com.revealprecision.reveal.util.Constants;
import com.revealprecision.reveal.util.Constants.CONFIGURATION;
import com.revealprecision.reveal.util.Constants.Filter;
import com.revealprecision.reveal.util.Constants.JsonForm;
import com.revealprecision.reveal.util.Country;
import com.revealprecision.reveal.util.PasswordDialogUtils;
import com.revealprecision.reveal.util.PreferencesUtil;
import com.revealprecision.reveal.util.RevealJsonFormUtils;
import com.revealprecision.reveal.view.EditFociBoundaryActivity;
...
import static com.revealprecision.reveal.contract.ListTaskContract.ListTaskView;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.COMPLETE;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.INCOMPLETE;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.IN_PROGRESS;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.NOT_ELIGIBLE;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.NOT_SPRAYABLE;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.NOT_SPRAYED;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.NOT_VISITED;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.PARTIALLY_SPRAYED;
import static com.revealprecision.reveal.util.Constants.BusinessStatus.SPRAYED;
import static com.revealprecision.reveal.util.Constants.DateFormat.EVENT_DATE_FORMAT_XXX;
import static com.revealprecision.reveal.util.Constants.DateFormat.EVENT_DATE_FORMAT_Z;
import static com.revealprecision.reveal.util.Constants.GeoJSON.FEATURES;
import static com.revealprecision.reveal.util.Constants.GeoJSON.TYPE;
import static com.revealprecision.reveal.util.Constants.Intervention.CDD_SUPERVISION;
import static com.revealprecision.reveal.util.Constants.Intervention.IRS;
import static com.revealprecision.reveal.util.Constants.Intervention.IRS_VERIFICATION;
import static com.revealprecision.reveal.util.Constants.Intervention.LARVAL_DIPPING;
import static com.revealprecision.reveal.util.Constants.Intervention.MOSQUITO_COLLECTION;
import static com.revealprecision.reveal.util.Constants.Intervention.PAOT;
import static com.revealprecision.reveal.util.Constants.Intervention.REGISTER_FAMILY;
import static com.revealprecision.reveal.util.Constants.JsonForm.DISTRICT_NAME;
import static com.revealprecision.reveal.util.Constants.JsonForm.ENCOUNTER_TYPE;
import static com.revealprecision.reveal.util.Constants.JsonForm.LOCATION_COMPONENT_ACTIVE;
import static com.revealprecision.reveal.util.Constants.JsonForm.PROVINCE_NAME;
import static com.revealprecision.reveal.util.Constants.JsonForm.VALID_OPERATIONAL_AREA;
import static com.revealprecision.reveal.util.Constants.LARVAL_DIPPING_EVENT;
import static com.revealprecision.reveal.util.Constants.MOSQUITO_COLLECTION_EVENT;
import static com.revealprecision.reveal.util.Constants.Map.CLICK_SELECT_RADIUS;
import static com.revealprecision.reveal.util.Constants.Properties.FAMILY_MEMBER_NAMES;
import static com.revealprecision.reveal.util.Constants.Properties.FEATURE_SELECT_TASK_BUSINESS_STATUS;
import static com.revealprecision.reveal.util.Constants.Properties.LOCATION_STATUS;
import static com.revealprecision.reveal.util.Constants.Properties.STRUCTURE_NAME;
import static com.revealprecision.reveal.util.Constants.Properties.TASK_BUSINESS_STATUS;
import static com.revealprecision.reveal.util.Constants.Properties.TASK_CODE;
import static com.revealprecision.reveal.util.Constants.Properties.TASK_CODE_LIST;
import static com.revealprecision.reveal.util.Constants.Properties.TASK_IDENTIFIER;
import static com.revealprecision.reveal.util.Constants.Properties.TASK_STATUS;
import static com.revealprecision.reveal.util.Constants.REGISTER_STRUCTURE_EVENT;
import static com.revealprecision.reveal.util.Constants.SPRAY_EVENT;
import static com.revealprecision.reveal.util.Utils.formatDate;
import static com.revealprecision.reveal.util.Utils.getMaxZoomLevel;
import static com.revealprecision.reveal.util.Utils.getPropertyValue;
import static com.revealprecision.reveal.util.Utils.isFocusInvestigation;
import static com.revealprecision.reveal.util.Utils.isFocusInvestigationOrMDA;
import static com.revealprecision.reveal.util.Utils.isKenyaMDALite;
import static com.revealprecision.reveal.util.Utils.isZambiaIRSLite;
import static com.revealprecision.reveal.util.Utils.validateFarStructures;
...
public class ListTaskPresenter implements ListTaskContract.Presenter, PasswordRequestCallback,
    ...
    public int getInterventionLabel() {
        return com.revealprecision.reveal.util.Utils.getInterventionLabel();
    }
    ...
    public void filterTasks(TaskFilterParams filterParams) {
        ...
        Set<String> filterInterventionUnitTasks = com.revealprecision.reveal.util.Utils.getInterventionUnitCodes(filterParams.getCheckedFilters().get(Filter.INTERVENTION_UNIT));
    ...
    public void searchTasks(String searchPhrase) {
        if (searchPhrase.isEmpty()) {
            ...
            for (Feature feature : !Utils.isEmptyCollection(searchFeatureCollection) && searchPhrase.length() > this.searchPhrase.length() ? searchFeatureCollection : Utils.isEmptyCollection(filterFeatureCollection) ? getFeatureCollection().features() : filterFeatureCollection) {
                ...
                if (com.revealprecision.reveal.util.Utils.matchesSearchPhrase(structureName, searchPhrase) ||
                        com.revealprecision.reveal.util.Utils.matchesSearchPhrase(familyMemberNames, searchPhrase))
