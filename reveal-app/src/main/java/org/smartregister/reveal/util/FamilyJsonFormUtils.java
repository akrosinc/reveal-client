...
import com.revealprecision.reveal.util.FamilyConstants.FormKeys;
...
public class FamilyJsonFormUtils extends JsonFormUtils {
    ...
    public static Event createFamilyEvent(String baseEntityId, String locationId, Map<String, String> details, String eventType) {
        ...
        com.revealprecision.reveal.util.Utils.tagEventMetadata(updateMemberNameEvent, com.revealprecision.reveal.util.Utils.getFormTag());
