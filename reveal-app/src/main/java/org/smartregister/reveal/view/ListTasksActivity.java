...
import com.revealprecision.reveal.model.FilterConfiguration;
...
import com.revealprecision.reveal.util.Constants.Action;
import com.revealprecision.reveal.util.Constants.Properties;
import com.revealprecision.reveal.util.Constants.TaskRegister;
import com.revealprecision.reveal.util.Country;
import com.revealprecision.reveal.util.RevealJsonFormUtils;
import com.revealprecision.reveal.util.RevealMapHelper;
...
import static com.revealprecision.reveal.util.Constants.ANIMATE_TO_LOCATION_DURATION;
...
import static com.revealprecision.reveal.util.Constants.CONFIGURATION.LOCAL_SYNC_DONE;
import static com.revealprecision.reveal.util.Constants.CONFIGURATION.UPDATE_LOCATION_BUFFER_RADIUS;
import static com.revealprecision.reveal.util.Constants.DatabaseKeys.STRUCTURE_ID;
import static com.revealprecision.reveal.util.Constants.DatabaseKeys.TASK_ID;
import static com.revealprecision.reveal.util.Constants.Filter.FILTER_CONFIGURATION;
import static com.revealprecision.reveal.util.Constants.Filter.FILTER_SORT_PARAMS;
...
import static com.revealprecision.reveal.util.Constants.RequestCode.REQUEST_CODE_FAMILY_PROFILE;
import static com.revealprecision.reveal.util.Constants.RequestCode.REQUEST_CODE_FILTER_TASKS;
import static com.revealprecision.reveal.util.Constants.RequestCode.REQUEST_CODE_GET_JSON;
import static com.revealprecision.reveal.util.Constants.RequestCode.REQUEST_CODE_TASK_LISTS;
import static com.revealprecision.reveal.util.Constants.SYNC_BACK_OFF_DELAY;
import static com.revealprecision.reveal.util.Constants.VERTICAL_OFFSET;
import static com.revealprecision.reveal.util.FamilyConstants.Intent.START_REGISTRATION;
import static com.revealprecision.reveal.util.Utils.displayDistanceScale;
import static com.revealprecision.reveal.util.Utils.getDrawOperationalAreaBoundaryAndLabel;
import static com.revealprecision.reveal.util.Utils.getLocationBuffer;
import static com.revealprecision.reveal.util.Utils.getPixelsPerDPI;
import static com.revealprecision.reveal.util.Utils.getSyncEntityString;
...
public class ListTasksActivity extends BaseMapActivity implements ListTaskContract.ListTaskView,
    ...
    public void positionMyLocationAndLayerSwitcher() {
        ...
        if (getBuildCountry() != Country.ZAMBIA && getBuildCountry() != Country.NAMIBIA
            ...
            int bottomMargin = com.revealprecision.reveal.util.Utils.getInterventionLabel() == R.string.irs ? progressHeight + 40 : 40;
            ...
            if (layerSwitcherFab != null) {
                ...
                if (com.revealprecision.reveal.util.Utils.getInterventionLabel() == R.string.irs)
    ...
    private BoundaryLayer createBoundaryLayer(Feature operationalArea) {
        return new BoundaryLayer.Builder(FeatureCollection.fromFeature(operationalArea))
                .setLabelProperty(com.revealprecision.reveal.util.Constants.Map.NAME_PROPERTY)
