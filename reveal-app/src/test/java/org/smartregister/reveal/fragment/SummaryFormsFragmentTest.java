...
public class SummaryFormsFragmentTest extends BaseUnitTest {
    ...
    public void testOpeningDailySummaryForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.DAILY_SUMMARY_ZAMBIA);
    ...
    public void testOpeningTeamLeaderDosForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.TEAM_LEADER_DOS_ZAMBIA);
        Whitebox.setInternalState(BuildConfig.class, BuildConfig.BUILD_COUNTRY, buildCountry);
    }
    ...
    public void testOpeningCBSprayForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.CB_SPRAY_AREA_ZAMBIA);
        Whitebox.setInternalState(BuildConfig.class, BuildConfig.BUILD_COUNTRY, buildCountry);
    }
    ...
    public void testOpeningIRSSADecisionForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.IRS_SA_DECISION_ZAMBIA);
        Whitebox.setInternalState(BuildConfig.class, BuildConfig.BUILD_COUNTRY, buildCountry);
    }
    ...
    public void testOpeningMobilizationForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.MOBILIZATION_FORM_ZAMBIA);
        Whitebox.setInternalState(BuildConfig.class, BuildConfig.BUILD_COUNTRY, buildCountry);
    }
    ...
    public void testOpeningIRSFieldOfficerForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.IRS_FIELD_OFFICER_ZAMBIA);
        Whitebox.setInternalState(BuildConfig.class, BuildConfig.BUILD_COUNTRY, buildCountry);
    }
    ...
    public void testOpeningVerificationForm() {
        ...
        verify(presenter).showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.VERIFICATION_FORM_ZAMBIA);
        Whitebox.setInternalState(BuildConfig.class, BuildConfig.BUILD_COUNTRY, buildCountry);
    }
