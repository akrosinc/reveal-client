...
import com.revealprecision.reveal.contract.OtherFormsfragmentContract;
import com.revealprecision.reveal.presenter.OtherFormsFragmentPresenter;
...
import com.revealprecision.reveal.view.SummaryFormsActivity;
        ...
        switch(view.getId()) {
            case R.id.summary_daily_summary:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.DAILY_SUMMARY_ZAMBIA);
            ...
            case R.id.summary_team_leader_dos:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.TEAM_LEADER_DOS_ZAMBIA);
                } else if (BuildConfig.BUILD_COUNTRY == Country.SENEGAL){
            ...
            case R.id.summary_cb_spray_area:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.CB_SPRAY_AREA_ZAMBIA);
                } else if (BuildConfig.BUILD_COUNTRY == Country.SENEGAL){
            ...
            case R.id.summary_irs_sa_decision:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.IRS_SA_DECISION_ZAMBIA);
                } else if (BuildConfig.BUILD_COUNTRY == Country.SENEGAL){
            ...
            case R.id.summary_mobilization_form:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.MOBILIZATION_FORM_ZAMBIA);
                } else {
            ...
            case R.id.summary_irs_field_officer:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.IRS_FIELD_OFFICER_ZAMBIA);
                } else if (BuildConfig.BUILD_COUNTRY == Country.SENEGAL){
            ...
            case R.id.summary_verification_form:
                if (BuildConfig.BUILD_COUNTRY == Country.ZAMBIA) {
                    presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.VERIFICATION_FORM_ZAMBIA);
                } else if (BuildConfig.BUILD_COUNTRY == Country.SENEGAL){
                    presenter.showBasicForm(Constants.JsonForm.VERIFICATION_FORM_SENEGAL);
                }
                break;
            case R.id.summary_tablet_accountability_form:
                presenter.showBasicForm(com.revealprecision.reveal.util.Constants.JsonForm.TABLET_ACCOUNTABILITY_FORM);
            default:
                break;
        }
    }
