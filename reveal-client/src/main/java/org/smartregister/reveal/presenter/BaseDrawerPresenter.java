...
import com.revealprecision.reveal.interactor.BaseDrawerInteractor;
import com.revealprecision.reveal.util.Country;
import com.revealprecision.reveal.util.PreferencesUtil;
import com.revealprecision.reveal.view.EventRegisterActivity;
...
import static com.revealprecision.reveal.util.Constants.Tags.CANTON;
import static com.revealprecision.reveal.util.Constants.Tags.COUNTRY;
import static com.revealprecision.reveal.util.Constants.Tags.DISTRICT;
...
import static com.revealprecision.reveal.util.Constants.Tags.PROVINCE;
import static com.revealprecision.reveal.util.Constants.Tags.REGION;
import static com.revealprecision.reveal.util.Constants.Tags.SUB_DISTRICT;
import static com.revealprecision.reveal.util.Constants.Tags.VILLAGE;
import static com.revealprecision.reveal.util.Constants.Tags.ZONE;
import static com.revealprecision.reveal.util.Constants.UseContextCode.INTERVENTION_TYPE;
...
public class BaseDrawerPresenter implements BaseDrawerContract.Presenter {
    ...
    private void populateLocationsFromPreferences() {
        ...
        if(com.revealprecision.reveal.util.Utils.isZambiaIRSLite() || com.revealprecision.reveal.util.Utils.isKenyaMDALite()) {
