...
import com.revealprecision.reveal.presenter.BaseDrawerPresenter;
...
import static com.revealprecision.reveal.util.Constants.COPYDBNAME;
import static com.revealprecision.reveal.util.Constants.DBNAME;
...
public class DrawerMenuView implements View.OnClickListener, BaseDrawerContract.View {
    ...
    public void setDistrict(String district) {
        com.revealprecision.reveal.util.Utils.setTextViewText(districtTextView, R.string.district, district);
    }

    @Override
    public void setFacility(String facility, String facilityLevel) {
        com.revealprecision.reveal.util.Utils.setTextViewText(facilityTextView,
                Tags.CANTON.equals(facilityLevel) ? R.string.canton : R.string.facility, facility);
    }

    @Override
    public void setOperator() {
        com.revealprecision.reveal.util.Utils.setTextViewText(operatorTextView, R.string.operator,
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.operational_area_selector)
            ...
            com.revealprecision.reveal.util.Utils.startImmediateSync();
            closeDrawerLayout();
        }
    }
